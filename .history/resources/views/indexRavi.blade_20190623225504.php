...
<body>
    ...
    <div class="section">
            <div class="container" style="width:70%; float:left">
                <p style="text-align:justify;">; margin-top: 80px; padding-right:70px; padding-left:140px;Rajesh engineering work is creative furniture hardware manufacturing company based in rajkot (gujarat).
                        Founded in 1994 REW has worked on creating various designer products. 
                        From the choice of steel, zamak or alluminium of the highest quality to the packaging of the finished handle, 
                        the entire production is followed with the utmost care and dedication.
                        margin-top:30px;Over the years we have established a range of products manufactured on inhouse facility to maintain quality at it's peak.</p>
            </div>
