...
<body>
  ...
  <nav class="white" role="navigation">
    ...
    <div class="card ">
        <div class=" card-tabs">
          <ul class="black-text tabs tabs-fixed-width" style="width:50%;">
            <li class="black-text tab"><a href="#test4">Door Handle</a></li>
            <li class="tab"><a class="active" href="#test5">Furniture Handle</a></li>
            <li class="tab"><a href="#test6">Other Hardware</a></li>
          </ul>
        </div>
