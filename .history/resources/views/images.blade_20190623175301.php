...
<div style="float:right; width:75%;"class = "container">
  ...
  <div class="col s12">  
    <ul class="tabs">  
      <li class="tab col s3"><a href="#inbox">Door Pull</a></li>  
  ...
  <div id="inbox" class="col s12">
    ...
    <div class="col s12 m12">
      <br>
      <section>
      <div class="container" style="padding-top: 0.7rem; float:left; height:75%; width:75%;">
                <div class="mySlides">
                  <div class="numbertext" style=" padding-top: 1.5rem;">1 / 3</div>
                  <img src="{{url('background1.jpg')}}" style="width:100%">
                </div>
      ...
      <div class="container" style="width:25%; float:right; padding: 0.7rem;">Details will go here...</div>
      </section>
    ...
    <section>
      <div class="container">
        <div class="row">
            <div class="column">
              <img class="demo cursor" src="{{url('background1.jpg')}}" onclick="currentSlide(1)" alt="The Woods">
            </div>
            <div class="column">
              <img class="demo cursor" src="{{url('background2.jpg')}}" onclick="currentSlide(2)" alt="Cinque Terre">
            </div>
            <div class="column">
              <img class="demo cursor" src="{{url('background3.jpg')}}" onclick="currentSlide(3)" alt="Mountains and fjords">
            </div>
