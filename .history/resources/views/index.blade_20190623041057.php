...
<body>
    ...
    <div class="carousel carousel-slider">
        <a href="#" data-target="slide-out" class="white-text sidenav-trigger"><i style="margin:10px;" class="material-icons">menu</i></a>
        <a class="carousel-item" href="#one!"><img src="{{url('background1.jpg')}}"></a>
        <a class="carousel-item" href="#two!"><img src="{{url('background2.jpg')}}"></a>
        <a class="carousel-item" href="#four!"><img src="{{url('background3.jpg')}}"></a>
    </div>
