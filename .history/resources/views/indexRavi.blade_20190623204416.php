                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <li><a class='dropdown-trigger' href='#' data-target='products_list'>Gallery</a></li>
                        ...
                        <ul id='other' class='dropdown-content'>
                            <li><a class="grey-text" href="#!">Coat Hooks</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text" href="#!">Door Closer</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text" href="#!">L-Bracket</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text" href="#!">Table Wire Manager</a></li>
                        </ul>
