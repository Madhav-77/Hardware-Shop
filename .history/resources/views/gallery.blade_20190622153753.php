...
.material-icons.md1:hover::after{
  content:"navigate_prev"; 
}
  ...
  <nav class="white" role="navigation">
    ...
    <div class="container">
        <div class="section">
            <div class="carousel">
            <div class="row">
                <button class="material-icons md1 next">Next</button>
                <button class="material-icons md1 prev">Previous</button>
