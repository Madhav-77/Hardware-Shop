...
<body>
  ...
  <ul id="slide-out" class="sidenav sidenav-fixed">
    ...
    <ul class="collapsible">
        <li class="bold"><a  style="height:30px; line-height: 30px;"class="collapsible-header waves-effect waves-grey">Home</a></li>
        <li class="bold"><a  style="height:30px; line-height: 30px;"class="collapsible-header waves-effect waves-grey">Gallery</a>
