    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <button style="float:right" class="btn-floating material-icons grey darken-3">chevron_left</button>
                <button style="float:right"class="btn-floating material-icons grey darken-3">chevron_right</button>
