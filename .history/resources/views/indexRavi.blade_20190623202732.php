                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <li><a class='dropdown-trigger' href='#' data-target='products_list'>Gallery</a></li>
                        <ul id='products_list' class='dropdown-content grey'>
                            <li><a class="dropdown-trigger white-text" data-target='door_handles' href="#!">Door Handles</a></li>
                            <ul id='door_handles' class='dropdown-content grey'>
                                <li><a class="white-text" href="#!">Furniture Handles</a></li>
                                <li><a class="white-text" href="#!">Other Hardwares</a></li>
                            </ul>
                            <li><a class="white-text" href="#!">Furniture Handles</a></li>
                            <li><a class="white-text" href="#!">Other Hardwares</a></li>
                        </ul>
