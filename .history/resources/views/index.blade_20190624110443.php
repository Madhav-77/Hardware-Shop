...
<body>
  ...
  <ul id="slide-out" class="sidenav sidenav-fixed">
    ...
    <li><a style="height:30px; line-height:30px;" href="#!">Home</a></li>
    <li><a style="height:30px; line-height:30px;" class='dropdown-trigger' data-target='door_handles' href="#!">Gallery</a></li>
    <li><a style="height:30px; line-height:30px;" href="#!">Second Link</a></li>
    <li><a style="height:30px; line-height:30px;" href="#!">Second Link</a></li>
