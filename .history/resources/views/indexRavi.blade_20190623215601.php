...
<body>
    ...
    <section>
        <div class="container" style="width:30%; float:left; margin-top:10px;">
            <h4 style="float:right;">Why</h4><br>
            <h4 style="float:right;">Choose</h4><br>
            <h4 style="float:right;">Us?</h4>
        </div>
        <div class="container" style="width:70%; float:right; margin-top:10px;">
