...
<body>
    ...
    <section>
        ...
        <div class="container" style="width:70%; float:right; margin-top: 30px; padding-left:70px; padding-right:140px;">
            <p>Rajesh engineering work is creative furniture hardware manufacturing company based in rajkot (gujarat).
