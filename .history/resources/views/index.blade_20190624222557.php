...
<body>
  ...
  <div class="navbar-wrapper">
      <div class="navbar-static">
          <nav class="nav" style=" -webkit-box-shadow:0 0px 0px 0 rgba(0, 0, 0, 0), 0 0px 0px 0px rgba(0, 0, 0, 0), 0 0px 0px 0 rgba(0, 0, 0, 0); 
              ...
              <div class="col s12">
                <div class="card">
                  <div class="card-image">
                    <img class="gallery box" src="{{URL::asset('images\02d4d344336067481a8445d1eb75437a.jpg')}}">
                  </div>
