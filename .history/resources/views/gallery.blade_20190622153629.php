...
<head>
  ...
  <script src="{{URL::asset('js/init.js')}}"></script>
    ...
    // function for prev slide
		$('.prev').click(function(){
      var prev = $('.carousel').carousel('prev');
      next.prev(3);
		});
	});
</script>
...
<body>
 ...
 <div class="carousel carousel-slider" data-indicators="true">
	<a herf="#one!" class="carousel-item"><img src="{{url('background1.jpg')}}"></a>
	<a herf="#two!" class="carousel-item"><img src="{{url('background2.jpg')}}"></a>
	<a herf="#three!" class="carousel-item"><img src="{{url('background3.jpg')}}"></a>
</div>
