...
<body>
  ...
  <nav class="white" role="navigation">
    <div class="nav nav-wrapper container" id="menu">
        <a href="#" data-target="slide-out" class="sidenav-trigger"><i class="left black-text material-icons">menu</i></a>
      <a id="logo-container" href="#" class="center brand-logo sidenav-trigger">Driver</a>
