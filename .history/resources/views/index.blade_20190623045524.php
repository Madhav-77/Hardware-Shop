...
<body>
    ...
    <a href="#" style="margin-top:50%;" data-target="slide-out" class="black-text sidenav-trigger"><i style="height:50%; margin:10px;" class="material-icons">menu</i></a>
  <img src="{{URL::asset('logoTemp.png')}}" style="float:right; height:100px; width:100px;">
    <div class="carousel carousel-slider center" data-indicators="true">
      <div class="carousel-fixed-item center middle-indicator">
        <div class="left">
          ...
          <div class="sel carousel-item" href="#one!">
              <img src="{{url('background1.jpg')}}">
            </div>
            <div class="sel carousel-item" href="#two!">
              <img src="{{url('background2.jpg')}}">
            </div>
          <div class="sel carousel-item" href="#three!">
            <img src="{{url('background3.jpg')}}">
          </div>
        </div>
