...
<div class="container" style="width:70%;  padding-top: 0.7rem;">
  <div class="mySlides">
    <div class="numbertext" style=" padding-top: 1.5rem;">1 / 6</div>
    <img src="{{url('background1.jpg')}}" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext" style="padding-top: 1.5rem;">2 / 6</div>
    <img src="{{url('background2.jpg')}}" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext" style="padding-top: 1.5rem;">3 / 6</div>
