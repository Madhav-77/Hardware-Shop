...
<body>
    ...
    <div class="section">
        ...
        <div class="container col l6 s12" style="width:70%; float:right; margin-top: 70px; margin-bottom: 100px; padding-left:70px; padding-right:140px;">
            <p style="text-align:justify;" class="col l3 s12">
                <b>Address</b>
                <address>RAJESH ENGINEERING WORK'S,<br>
                    5 Patel Nagar,<br> 
                    80 Feet Road,<br> 
                    Rajkot - 360002<br> 
                    (Gujarat - India)</address></p>
                    <p style="text-align:justify;" class="col l3 s12">
                            <b>Address</b>
                            <address>RAJESH ENGINEERING WORK'S,<br>
                                5 Patel Nagar,<br> 
