                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <li><a class='dropdown-trigger' href='#' data-target='products_list'>Gallery</a></li>
                        ...
                        <ul id='other' class='dropdown-content'>
                            <li><a class="grey-text darken-3" href="#!">Coat Hooks</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text darken-3" href="#!">Door Closer</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text darken-3" href="#!">L-Bracket</a></li>
                            <li class="divider"></li>
                            <li><a class="grey-text darken-3" href="#!">Table Wire Manager</a></li>
                        </ul>
