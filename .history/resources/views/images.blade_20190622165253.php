...
<div class="container" style="width:70%;  padding-top: 0.7rem; float:left; margin-left: 0.7rem;">
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="{{url('background3.jpg')}}" style="width:100%" onclick="currentSlide(4)" alt="Mountains and fjords">
    </div>
    <div class="column">
      <img class="demo cursor" src="{{url('background3.jpg')}}" style="width:100%" onclick="currentSlide(5)" alt="Mountains and fjords">
    </div>
    <div class="column">
      <img class="demo cursor" src="{{url('background3.jpg')}}" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
