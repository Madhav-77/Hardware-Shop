...
<body>
    ...
    <div class="section">
        <div class="container" style="width:30%; float:left; margin-top:30px; margin-bottom:40px;">
            <h1><span style="float:right">Why</span><br><span style="float:right">Choose</span><br><span style="float:right">Us?</span></h1>
        </div>
        <div class="container" style="width:70%; float:right; margin-top: 80px; margin-bottom: 90px; padding-left:70px; padding-right:140px;">
