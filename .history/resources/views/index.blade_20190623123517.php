...
<body>
    ...
    <div class="navbar-wrapper">
        <div class="container">
          <div class="navbar navbar-inverse navbar-static-top" style="background:transparent; border-color:transparent; width:100%; margin-top:0;">
      ...
      <div class="carousel-fixed-item center middle-indicator">
        <div class="left">
          ...
          <div class="carousel-item" href="#one!">
              <img class="img" src="{{url('background1.jpg')}}">
            </div>
