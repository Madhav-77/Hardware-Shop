                    ...
                    <ul id="nav-mobile" class="right hide-on-med-and-down">
                        ...
                        <li><a class='dropdown-trigger' href='#' data-target='products_list'>Gallery</a></li>
                            <ul id='products_list' class='dropdown-content grey'>
                                ...
                                <li><a class="white-text dropdown-button2 d" href="#!" data-target='furniture' data-alignment="left">Furniture Handles</a></li>
                                <li><a class="white-text dropdown-button2 d" href="#!" data-target='other' data-alignment="left">Other Hardwares</a></li>
                            </ul>
                            {{-- submenus --}}
