  ...
  <body style="background: #F0F0F0;">
    ...
    <section class="hero" id="gallery">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="display-3" align="center">Gallery</h1>
          </div>
        </div>
      </div>
    </section>
    <section class="hero" id="aboutUs">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="display-3" align="center">About Us</h1>
          </div>
        </div>
      </div>
    </section>
    <section class="hero" id="contactUs">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="display-3" align="center">Contact Us</h1>
          </div>
        </div>
      </div>
    </section>
