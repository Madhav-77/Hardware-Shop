...
<div style="float:right; width:75%;"class = "container">
  ...
  <div id="inbox" class="col s12">
    ...
    <section>
      ...
      <div class="row">
          <div class="column">
            <img src="{{url('background1.jpg')}}" alt="Nature" style="width:100%" onclick="currentSlide(1);">
          </div>
          <div class="column">
            <img src="{{url('background2.jpg')}}" alt="Snow" style="width:100%" onclick="currentSlide(2);">
          </div>
          <div class="column">
            <img src="{{url('background3.jpg')}}" alt="Mountains" style="width:100%" onclick="currentSlide(2);">
          </div>
        </div>
    </section>
  </div>  
