...
<body>
    ...
    <div class="row left"><a href="#" data-target="slide-out" class=" middle-indicator-text align-top black-text sidenav-trigger"><i style="margin:10px;" class="material-icons">menu</i></a>
    </div>
