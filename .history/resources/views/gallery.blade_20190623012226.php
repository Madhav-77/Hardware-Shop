    ...
    <div class="card">
        <div class="card-tabs">
          <ul class="tabs tabs-fixed-width" style="width:50%;">
            <li class="black-text tab"><a class="black-text" href="#test4">Door Handle</a></li>
            <li class="tab"><a class="active black-text" href="#test5">Furniture Handle</a></li>
            <li class="tab"><a class="black-text" href="#test6">Other Hardware</a></li>
          </ul>
        </div>
